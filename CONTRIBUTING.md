...
Welcome to `geo-drawer` contributor's guide.
...
If you experience bugs or general issues with `geo-drawer`, please have a look
...
You can help improve `geo-drawer` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`geo-drawer` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `geo-drawer`'s files. While this mechanism can
...
```
conda create -n geo-drawer python=3 six virtualenv pytest pytest-cov
conda activate geo-drawer
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/geo-drawer.git
   cd geo-drawer
   ```
...
5. Install [pre-commit]:
   ...
   `geo-drawer` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/geo-drawer
[issue tracker]: https://github.com/<USERNAME>/geo-drawer/issues
